![docker image](https://github.com/Guillaume-Gaisne/NOMAD_Oasis/actions/workflows/docker-publish.yml/badge.svg)


# Guillaume-Gaisne's NOMAD Oasis Distribution

This is the NOMAD Oasis distribution of Guillaume-Gaisne.
...
2. Clone the repository or download the repository as a zip file.
    ...
    ```sh
    git clone https://github.com/Guillaume-Gaisne/NOMAD_Oasis.git
    cd NOMAD_Oasis
    ```
    ...
    ```sh
    curl-L -o NOMAD_Oasis.zip "https://github.com/Guillaume-Gaisne/NOMAD_Oasis/archive/main.zip"
    unzip NOMAD_Oasis.zip
    cd NOMAD_Oasis
    ```
...
your `docker-compose.yaml` with `ghcr.io/guillaume-gaisne/nomad_oasis:main` for the services
...
```sh
docker pull ghcr.io/guillaume-gaisne/nomad_oasis/jupyter:main
```
...
By default, documentation is built using the [nomad-docs](https://github.com/Guillaume-Gaisne/nomad-docs) repository. However, if you'd like to customize the documentation for your Oasis instance, you can easily do so.

1. First, [fork the nomad-docs repository](https://github.com/Guillaume-Gaisne/nomad-docs/fork).
...
_I get an_ `Error response from daemon: Head "https://ghcr.io/v2/Guillaume-Gaisne/NOMAD_Oasis/manifests/main": unauthorized`
